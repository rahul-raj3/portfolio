...
<div className="bg-slate-900 px-6 py-3 gap-4">
      <div className="flex items-center justify-center text-center relative">
        <p className="text-[12px] lg:text-[15px]  text-white font-medium pr-6 leading-relaxed tracking-wider">
            🚀 We're live! Start your learning journey now.
          {/* <a href="javascript:void(0)" className="ml-1">Start Now!</a> */}
          </p>
