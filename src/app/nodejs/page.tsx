...
const Nodejs = () => {
    return(
        <>
            <Announcement />
            <Header />
{/* <div className="bg-gradient-to-r from-[#ffec80] to-[#9089fc] min-h-screen"> */}
...
<aside id="separator-sidebar" className="absolute top-28 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className=" px-3 py-4 overflow-y-auto  bg-gradient-to-r from-[#ededed] to-[#e8e8ed]">
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Event Loop</span>
